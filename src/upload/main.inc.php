...
**********************************************************************/    
   ...
   //Path separator
    ...
    define('STAFF_API_TABLE',TABLE_PREFIX.'staff_api');
    ...
    if(!($cfg=Sys::getConfig())){
        die('Unable to load config info from DB. Get tech support.');
    }

    if(!ini_get('short_open_tag')) {
        die('Short open tag disabled! - osTicket requires it turned ON.');
    }
