...
<table width="100%" border="0" cellspacing=1 cellpadding=2>
  <form action="tickets.php?id=<?=$ticket->getId()?>" method="post">
    ...
    <tr>
        ...
        <td>
            <input type="text" name="siteName" size="25" value="<?=$info['siteName']?>">
        </td>
    </tr>
    <tr>
        <td align="left">Site Address:</td>
        <td>
            <input type="text" name="siteAddress" size="25" value="<?=$info['siteAddress']?>">
        </td>
    </tr>
    <tr>
        <td align="left">City, State, Zip:</td>
        <td>
            <input type="text" name="csz" size="25" value="<?=$info['csz']?>">
        </td>
    </tr>
    <tr>
        <td align="left">Contact Name:</td>
        <td>
            <input type="text" name="contactName" size="25" value="<?=$info['contactName']?>">
        </td>
    </tr>
    <tr>
        <td align="left">Contact Phone:</td>
        <td>
            <input type="text" name="contactPhone" size="25" value="<?=$info['contactPhone']?>">
        </td>
    </tr>
    <tr>
        <td align="left">Contact Email:</td>
        <td>
            <input type="text" name="contactEmail" size="25" value="<?=$info['contactEmail']?>">
        </td>
    </tr>
    <tr>
        <td align="left">Travel:</td>
        <td>
            <input type="text" name="travel" size="25" value="<?=$info['travel']?>">
        </td>
    </tr>
    <tr>
        <td align="left">Travel Rate:</td>
        <td>
            <input type="text" name="travelrate" size="25" value="<?=$info['travelrate']?>">
        </td>
    </tr>
    <tr>
        <td align="left" valign="top">Scope of Work:</td>
        <td>
            <textarea name="sow" cols="55" rows="8" wrap="soft"><?=$info['sow']?></textarea>
        </td>
    </tr>
