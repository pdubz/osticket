...
if(!defined('OSTSCPINC') || !@$thisuser->isStaff() || !is_object($ticket) ) die('Invalid path viewticket.inc.php');
...
<table width="100%" cellpadding="2" cellspacing="0" border="0">
    ...
    <tr>
     <td valign="top" width=50%>
        ...
        <tr>
        <th>Contact Phone:</th>
        <td><?=$ticket->getContactPhone()?></td>
        </tr>
        <tr>
        <th>Contact Email:</th>
        <td><?=$ticket->getContactEmail()?></td>
        </tr>
        <tr>
        <th>Travel:</th>
        <td><?=$ticket->getTravel()?></td>
        </tr>
        <tr>
            <th>Travel Rate:</th>
            <td><?=$ticket->getTravelRate()?></td>
        </tr>
        </table>
     </td>
     <td width=50% valign="top">
        <table align="center" class="ticketinfo" cellspacing="1" cellpadding="3" width="100%" border=0>
            ...
            <tr height="165">
                <th nowrap valign="top">Scope of Work:</th>
                <td valign="top"><?=$ticket->getSOW()?></td>
            </tr>
        </table>
     </td>
    </tr>
