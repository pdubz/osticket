...
class Misc {
    ...
    function currentURL() {
        ...
        if ($_SERVER['SERVER_PORT']!=80) {
            $str .= isset($_ENV['OST_URL'])?$_ENV['OST_URL']:$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].$_SERVER['REQUEST_URI'];
        } else {
            $str .= isset($_ENV['OST_URL'])?$_ENV['OST_URL']:$_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI'];
        }
